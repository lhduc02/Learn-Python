...
Bình muốn tô lại sao cho không có 2 ô màu nào cạnh nhau có cùng một màu. Hãy giúp Bình tìm số bước ít nhất để đạt được điều đó.

Input
Dòng đầu là số nguyên n (1 ≤ n ≤ 1000) — chiều dài của băng giấy.
